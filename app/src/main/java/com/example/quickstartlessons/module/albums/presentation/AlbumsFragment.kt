...
class AlbumsFragment : Fragment() {
    ...
    private fun setupListeners() {
        ...
        binding.navigateToDetailsButton.setOnClickListener {
            findNavController().navigate(R.id.action_albumsFragment_to_albumDetailsFragment)
           //findNavController().navigate(AlbumsFragmentDirections.actionAlbumsFragmentToAlbumDetailsFragment("1"))
        }
    }
