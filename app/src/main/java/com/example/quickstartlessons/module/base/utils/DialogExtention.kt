...
import com.example.quickstartlessons.module.base.utils.Helper.getDeviceDisplayMetrics
...
fun Activity.createMessageDialog(errorMessageData: QSDefaultDialogData, isShowCancelButton: Boolean = false): Dialog? {
    return createMessageDialog(errorMessageData, this, isShowCancelButton)
}
...
fun createMessageDialog(messageData: QSDefaultDialogData, context: Context, isShowCancelButton: Boolean = false): Dialog {
...
data class QSDefaultDialogData(
    var title: String = QsConstants.EMPTY_STRING,
    var message: String = QsConstants.EMPTY_STRING,
    @DrawableRes var iconRes: Int? = null,
    var isCancelable: Boolean = true,
    var positiveButtonText: String = QsConstants.EMPTY_STRING,
    var negativeButtonText: String = QsConstants.EMPTY_STRING,
